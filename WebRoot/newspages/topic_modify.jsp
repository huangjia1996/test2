...
<div id="admin_bar">
	<div id="status">
		管理员： 登录 &#160;&#160;&#160;&#160; <a href="../util/do_logout.jsp">login
			out</a>
	</div>
	<div id="channel"></div>
</div>
...
<body>
	...
	<div id="main">
		...
		<div id="opt_area">
			...
			<form action="../util/topic_ control.jsp?opr=update" method="post"
				onsubmit="return check()">
				<p>
					<label> 主题名称 </label> <input name="tname" type="text"
						class="opt_input"
						value=<%String name = new String(request.getParameter("tname").getBytes("ISO-8859-1"), "UTF-8");
			out.print(name);%> />
